...
**Note**: The configuration isn't fully developed yet, and so DataPipes only supports a single CSV format at the moment! This is probably useless for most people in it's current state.
